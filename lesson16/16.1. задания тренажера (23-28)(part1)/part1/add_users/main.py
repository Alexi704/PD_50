...
user_1 = User(email='novlu@mail.com', password='mkdXjIjYM', full_name='Людмила Новикова', city_ru='Санкт-Петербург')
user_2 = User(email='tripper678@yahhaa.com', password='eGGPtRKS5', full_name='Андрей Васечкин', city_ru='Москва')
user_3 = User(email='georgiberidze@mail.com', password='NWRV0Z9ZC', full_name='Георги Беридзе', city_ru='Тбилиси')
user_4 = User(email='oksi.laslas89@mail.com', password='TenhtQOjv', full_name='Оксана Ласкина', city_ru='Казань')
user_5 = User(email='vanyahot888@inmail.com', password='5YGRPtYlw', full_name='Иван Горячий', city_ru='Сочи')
