...
@app.route('//')
def page_index():
    return 'Главная страничка. Тут ничего нет)))'
...
def page_get_order(order_id):
    """ Возвращаем список ордера по его id. """
...
def page_get_offer(offer_id):
    """ Показываем один оффер по его id. """
...
def create_user():
    ...
    db.session.commit()
    return 'данные ушли... за новорожденным'
...
def edit_user(user_id):
    ...
    return f'данные ушли... исправлять косяки у пользователя с id: {user_id}'
...
def delete_user(user_id):
    ...
    return 'данные ушли... но кого-то уже не вернуть...'
...
def create_order():
    ...
    db.session.commit()
    return 'данные ушли... за новым заказом!'
...
def edit_order(order_id):
    ...
    return f'данные ушли... что-то изменилось в заказе с id: {order_id}'
...
def create_offer():
    ...
    db.session.commit()
    return 'данные ушли... за новым офером!'
